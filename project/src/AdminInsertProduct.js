              ...
              <form action='' method='post' onSubmit={this.submitForm} encType='multipart/form-data'>
                  ...
                  <div className="col">
                    <div className="form-floating mb-3">
                      <input type="text" className="form-control" id="title" placeholder="Product title"
                        name="name" onChange={this.UpdateValue} />
                      <label htmlFor="name">Product title</label>
                    </div>
                  </div>
                  <div className="col">
                    <select className="form-select form-select-lg" aria-label="Large select"
                      name="categoryid" onChange={this.UpdateValue}>
                ...
                <div className="row">
                  <div className="col">
                    ...
                    <input className="form-control" type="file" id="filename" name="filename"
                      accept="image/*" onChange={this.ChangeFile} />
                  </div>
                  <div className="col">
                    <div className="form-floating mb-3 mt-3">
                      <input type="number" className="form-control" id="price" placeholder="Product price"
                        name="price" onChange={this.UpdateValue} />
                  ...
                  <div className="col">
                    <div className="form-floating mb-3 mt-3">
                      <input type="number" className="form-control" id="stock" placeholder="Product stock"
                        name="stock" onChange={this.UpdateValue} />
                    ...
                    <div className="col-9">
                      <div className="form-floating">
                        <textarea className="form-control" placeholder="Product description" id="detail"
                          style={{ "height": "100px" }} name="detail" defaultValue={""} onChange={this.UpdateValue} />
