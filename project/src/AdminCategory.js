...
class AdminCategory extends Component {
  ...
  componentDidMount() {
    ...
    let url = 'http://theeasylearnacademy.com/shop/ws/category.php';
    fetch(url).then((Response) => Response.json()).then((json) => {
      ...
      */
      ...
      if (error !== "no") //means error
      {
        ...
        console.log(total);
        json.splice(0, 2); //  1st argument position, 2nd argument no of items to be remove from json
                ...
                <tbody><tr>
                  ...
                  {this.state.categories.map(function (category) {
                    return (<tr>
                      ...
                      <td>
                        <Link to="/admin-edit-category"><i className="fa fa-pencil fa-2x" /></Link>
                      </td>
                      <td>
