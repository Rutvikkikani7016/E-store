...
class AdminInsertCategory extends Component {
  ...
  saveCategory = (event) => {
    ...
    axios({
      method: 'post',
      url: 'http://theeasylearnacademy.com/shop/ws/category.php',
      data: formData,
                ...
                <div className="row">
                  ...
                  <div className="col">
                    ...
                    <div className="form-check form-check-inline">
                      <input className="form-check-input" type="radio" name="islive" id="yes" defaultChecked value='1' onChange={this.updateValue} />
                      <label className="form-check-label" htmlFor="yes">Yes</label>
                    </div>
                    <div className="form-check form-check-inline">
                      <input className="form-check-input" type="radio" name="islive" id="no" value='0' onChange={this.updateValue} />
