                  ...
                  <div className="row justify-content-between align-items-center">
                    ...
                    <div className="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                      <div className="hero__img" data-animation="bounceIn" data-delay=".4s">
                        <img src="theme/assets/img/hero/watch.png" alt className=" heartbeat" />
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                  <div className="single-new-pro mb-30 text-center">
                    <div className="product-img">
                      <img src="theme/assets/img/gallery/new_product1.png" alt />
                    </div>
              ...
              <div className="row">
                <div className="col-xl-6 col-lg-4 col-md-6 col-sm-6">
                  <div className="single-gallery mb-30">
                    <div className="gallery-img big-img" style={{ "background-image": "url(theme/assets/img/gallery/gallery1.png)" }} />
                  </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                  <div className="single-gallery mb-30">
                    <div className="gallery-img big-img" style={{ "background-image": "url(theme/assets/img/gallery/gallery2.png)" }} />
                  </div>
                </div>
                <div className="col-xl-3 col-lg-4 col-md-12">
                  <div className="row">
                    <div className="col-xl-12 col-lg-12 col-md-6 col-sm-6">
                      <div className="single-gallery mb-30">
                        <div className="gallery-img small-img" style={{ "background-image": "url(theme/assets/img/gallery/gallery3.png)" }}>
                        </div>
                      </div>
                    </div>
                    <div className="col-xl-12 col-lg-12  col-md-6 col-sm-6">
                      <div className="single-gallery mb-30">
                        <div className="gallery-img small-img" style={{ "background-image": "url(theme/assets/img/gallery/gallery4.png)" }}>
                        </div>
                      </div>
                    </div>
                  </div>
